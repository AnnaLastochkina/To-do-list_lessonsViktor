...
import {v1} from "uuid";
import {AddTodolistAC, AddTodoListAT, RemoveTodolistAC, RemoveTodolistAT} from "./todolists-reducer";
...
export const changeTaskStatusAC = (taskId:string, isDone:boolean, todolistId: string): changeTaskStatusTypeAT => {
